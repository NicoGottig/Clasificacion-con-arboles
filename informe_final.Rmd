...
Además, se divide el conjunto de datos en un conjunto de entrenamiento (70 %) uno de prueba (20 %) con el que se buscarán los mejores parámetros y uno de validación (10 %) con el que se expondrán los resultados finales.  
...
En primer lugar se elegirá el mejor modelo entre los ajustados, siendo el elegido el basado en el algoritmo LightGBM, con variables transformadas y sin estandarizar, según las medidas de clasificación dispuestas en la figura 11. 
